...
function zoomToFeature(e) {
  ...
  main.variable(observer("fortaleza_crimes_populacao")).define("fortaleza_crimes_populacao", ["d3"], function(d3){return(
d3.csv("https://gist.githubusercontent.com/emanueles/8ee225792454a78151d0842a10642a29/raw/9984e32effa99da3cea2ec87a7c9b7b231c71d3c/fortaleza_crimes_populacao.csv").then(function(data){
  ...
  main.variable(observer("info")).define("info", ["L","fortaleza_crimes_populacao","map"], function(L,fortaleza_crimes_populacao,map)
{
  // control that shows state info on hover
	...
	infoControl.update = function (feat) {
			this._div.innerHTML = '<h5>Número de homicídios</h5>' +  (feat ?
				'<b>' + feat.properties.NOME + '</b><br />' + fortaleza_crimes_populacao.get(feat.properties.NOME)[0] 
              + ' homicídios.<br/>' + fortaleza_crimes_populacao.get(feat.properties.NOME)[1] 
              + ' homicídios p/ 100 mil Hab.'
...
d3.csv("https://gist.githubusercontent.com/emanueles/bae10fc42b13886b5a00b79737f2b50d/raw/ffb35abe6d9ba0c4ce4866b827f1916748ab65ef/homicidios_2012.csv").then(function(data) {
  ...
  main.variable(observer("style")).define("style", ["colorScale","fortaleza_crimes_populacao"], function(colorScale,fortaleza_crimes_populacao){return(
function style(feature) {
		 return {
					...
					dashArray: '3',
					fillOpacity: 0.6,
					fillColor: colorScale(fortaleza_crimes_populacao.get(feature.properties.NOME)[1])
				};
	}
)});
