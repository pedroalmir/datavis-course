// https://observablehq.com/@pedroalmir/ldavis@258
export default function define(runtime, observer) {
  const main = runtime.module();
  main.variable(observer()).define(["md"], function(md){return(
md`# LDAvis`
)});
  main.variable(observer("LDAvis")).define("LDAvis", ["width","d3","location","history"], function(width,d3,location,history)
{
...
return LDAvis;  
  ...
  main.variable(observer("location")).define("location", function(){return(
window.location
)});
  main.variable(observer("history")).define("history", function(){return(
window.history
)});
