// https://observablehq.com/d/22466d58aaebf35f@2512
  ...
  main.variable(observer("factsAndDims")).define("factsAndDims", ["crossfilter","myData"], function(crossfilter,myData)
{
  ...
  return {
    ...
    tagsDimPosts: tagsDimPosts, postsByTagsGroup: postsByTagsGroup
  }
}
);
  main.variable(observer("postByYearContainer")).define("postByYearContainer", ["md","dashContainer"], function(md,dashContainer)
{
  ...
  main.variable(observer("interactiveChartTagsByYear")).define("interactiveChartTagsByYear", ["md","dashContainer"], function(md,dashContainer)
{
  return md `${dashContainer('interactiveChartTagsByYear')}`
}
);
  ...
  main.variable(observer("by_year")).define("by_year", ["dc","widths","factsAndDims","d3"], function(dc,widths,factsAndDims,d3)
{
  ...
  main.variable(observer("interactiveChartTags_by_year")).define("interactiveChartTags_by_year", ["dc","widths","factsAndDims"], function(dc,widths,factsAndDims)
{
  let rowChart = dc.rowChart("#interactiveChartTagsByYear")
  
  rowChart
    .renderLabel(true)
    .width(widths.byTagsContainerWidth).height(600)
    .margins({top: 30, right: 50, bottom: 25, left: 40})
    .dimension(factsAndDims.tagsDimPosts)
    .group(factsAndDims.postsByTagsGroup)
